...
import java.util.Optional; //It will Avoid the NullPointer Exception.
...
public class CustomerController {
    ...
    public ResponseEntity<Optional<Customer>>getDataById(@RequestBody int custId){
    ...
    public ResponseEntity<Customer>updateData(int custId, @RequestBody Customer customer) throws RecordNotFoundException {
        //
